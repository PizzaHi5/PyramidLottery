      ...
      <div className="drawer-side">
        ...
        <ul className="p-4 overflow-y-auto menu w-80 bg-base-100 gap-10 sm:flex items-center">
          <li>
            <Text
              variant="heading"
              className="font-extrabold tracking-tighter text-center text-transparent bg-clip-text bg-gradient-to-br from-orange-500 to-white mt-10"
            >
              Menu
            </Text>
          </li>
          ...
          <li>
            <NavElement label="Pool" href="/pool" />
          </li>
        </ul>
      </div>
    </div>
